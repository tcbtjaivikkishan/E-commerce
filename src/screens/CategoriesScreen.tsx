...
// ─── Import your products JSON (adjust path as needed) ───────────────────────
...
// ─── Build lookup map: item_id → full Product ────────────────────────────────
...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: "13",
        item_id: "2876968000000039983",
        name: "Bhumiraja 4kg",
        image: null,
      },
      {
        id: "14",
        item_id: "2876968000000033454",
        name: "PROM 50kg",
        image:
...
export default function CategoryScreen(): React.JSX.Element {
  ...
  const handleProductPress = (cardItem: CategoryItem): void => {
    router.push(`/product/${cardItem.item_id}`);
  };
...
const styles = StyleSheet.create({
  ...
  deliveryRow: { flexDirection: "row", alignItems: "center", marginTop: 1 },
  deliveryTime: {
    color: "#FFFFFF",
    fontSize: 18,
    fontWeight: "800",
  ...
  locationSep: { color: "#FFFFFF", fontSize: 12, opacity: 0.6 },
  locationText: {
    color: "#FFFFFF",
    fontSize: 12,
    fontWeight: "500",
  ...
  micBtn: { padding: 4 },
  micIcon: { fontSize: 18, opacity: 0.65 },
  scrollView: { flex: 1 },
  ...
  seeAll: { fontSize: 12, color: "#2E7D32", fontWeight: "600" },
